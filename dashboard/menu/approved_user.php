...
// Query untuk menggabungkan data dari tabel mahasiswa dan pendaftaran
$query = "
    SELECT 
        m.mahasiswa_id, 
        m.nama_lengkap, 
    ...
    JOIN 
        pendaftaran p
    ON 
        m.mahasiswa_id = p.mahasiswa_id
    ORDER BY 
        m.waktu_pendaftaran DESC
";
    ...
    <tbody>
        ...
        if (!empty($data)) {
            ...
            foreach ($data as $row) {
                ...
                echo "<td>" . htmlspecialchars($row['waktu_pendaftaran']) . "</td>";
